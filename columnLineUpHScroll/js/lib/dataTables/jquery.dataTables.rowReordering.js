// NOTE: This file has been edited: please see lines 104 and 154 - these need to be
// reimplemented if this lib is upgraded
// ================================================================================
// ================================================================================
...
(function ($) {
    ...
    $.fn.rowReordering = function (options) {
        ...
        function fnMoveRows(oTable, sSelector, iCurrentPosition, iNewPosition, sDirection, id, sGroup) {
            // --EDIT--
            var rowData = oTable.DataTable().row($("#" + id)).data();
			...
			// --EDIT--
            oTable.trigger("rowReordering.dt", [iCurrentPosition, iNewPosition, id, rowData])
        }
